...
// PDF Document Component for SOAP Note
const SoapNotePdf = ({ appointment }: any) => {
    ...
    return (
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                {/* SOAP Details */}
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>SOAP Details</Text>

                    <View style={styles.soapSection}>
                        <Text style={styles.soapLabel}>Subjective: Client&apos;s history and current status</Text>
                        <Text style={styles.soapSubLabel}>Medical or Mental History, Complaints and/or problems</Text>
                        <View style={styles.soapContentContainer}>
                            <Text style={styles.soapContent}>
                                {appointment.subjective.medicalHistory}
                            </Text>
                        </View>
                    </View>

                    <View style={styles.soapSection}>
                        <Text style={styles.soapLabel}>Objective: Quantitative, factual, and measurable data</Text>
                        <Text style={styles.soapSubLabel}>Physical and Psychological Observations</Text>
                        <View style={styles.soapContentContainer}>
                            <Text style={styles.soapContent}>
                                {appointment.objective.physicalObservations}
                            </Text>
                        </View>
                    </View>

                    <View style={styles.soapSection}>
                        <Text style={styles.soapLabel}>Assessment: Create your official assessment</Text>
                        <Text style={styles.soapSubLabel}>DSM Criteria/Therapeutic Model | Clinical and professional knowledge</Text>
                        <View style={styles.soapContentContainer}>
                            <Text style={styles.soapContent}>
                                {appointment.assessment.dsmCriteria}
                            </Text>
                        </View>
                    </View>

                    <View style={styles.soapSection}>
                        <Text style={styles.soapLabel}>Plan: Outline your plan for future sessions</Text>
                        <Text style={styles.soapSubLabel}>Next Steps for Upcoming Sessions | How you&apos;ll implement your treatment plan</Text>
                        <View style={styles.soapContentContainer}>
                            <Text style={styles.soapContent}>
                                {appointment.plan.nextSteps}
                            </Text>
                        </View>
                    </View>
                </View>
...
export const uploadSoapNoteOnAppointment = async (appointment: any) => {
    try {
        ...
        if (!uploadResponse.ok) {
            throw new Error('Failed to upload SOAP note');
        }

        return { uploadedKey: key, signedUrl };
    } catch (error) {
        console.error('Error generating and uploading SOAP note PDF:', error);
        throw error;
    }
}

export default SoapNotePdf;